              ...
              <div className="flex-shrink-0 flex items-center">
                <h1 className="text-xl font-bold text-gray-900">CodeCompanionPro</h1>
                  ...
                  <div className="hidden sm:ml-6 sm:flex sm:space-x-6">
                    ...
                    <button
                      onClick={() => setCurrentPage('engine')}
                      className={`px-3 py-2 rounded-md text-sm font-medium ${
                        currentPage === 'engine' ? 'bg-blue-100 text-blue-700' : 'text-gray-500 hover:text-gray-700'
                      }`}
                    >
                      Engine
                    </button>
                    ...
                    <button
                      ...
                      className={`px-3 py-2 rounded-md text-sm font-medium ${
                        currentPage === 'help' ? 'bg-blue-100 text-blue-700' : 'text-gray-500 hover:text-gray-700'
                      }`}
                    >
                      Help
                    </button>
