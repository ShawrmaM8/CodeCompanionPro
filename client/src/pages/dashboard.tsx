  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">Welcome to your AI Code Tutor</p>
      </div>
                  ...
                  <div className="relative pb-8">
                    <div className="relative flex space-x-3">
                      ...
                      <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                        <div>
                          <p className="text-sm text-gray-500">Completed JavaScript Basics skill</p>
                        </div>
                ...
                <li>
                  <div className="relative pb-8">
                    <div className="relative flex space-x-3">
                      ...
                      <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                        <div>
                          <p className="text-sm text-gray-500">Analyzed React component code</p>
                        </div>
                        <div className="text-right text-sm whitespace-nowrap text-gray-500">
                          <time>1 day ago</time>
                        </div>
